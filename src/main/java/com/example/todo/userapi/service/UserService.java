...
public class UserService {
    ...
    private String getKakaoAccessToken(String code) {
        ...
        params.add("client_id",KAKAO_CLIENT_ID); // 카카오 디벨로퍼 REST_API키
        params.add("redirect_uri",KAKAO_REDIRECT_URI); // 카카오 디벨로퍼 등록된 redirect uri
        params.add("code",code); // 프론트에서 인가코드 요청시 전달받은 코드값
        params.add("client_secret",KAKAO_CLIENT_SECRET); //카카오 디벨로퍼 client secret(활성화 시 추가해 줘야함)
        ...
        log.info("토큰 요청 응답 데이터의 값은 ? : {} " , responseData );
