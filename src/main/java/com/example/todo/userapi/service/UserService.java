...
public class UserService {
    ...
    public boolean isDuplicate(String email) {
        ...
        return userRepository.existsByEmail(email); // 이메일 존재하면 true, 없으면 false
    }
    ...
    public void authenticate(final LoginRequestDTO dto){
        ...
        if(!passwordEncoder.matches(rawPassword,encodedPassword)) { // 둘이 같다면 true
